  ...
  await formEl.validate(async (valid, fields) => {
    if (valid) {
      const form = {
        ...
        operateTag: 1,
        stopName: memberForm.stopName,
        idNum: memberForm.idNum,
      };
  ...
  <Modal>
    <div class="p-4 pb-0">
      ...
      >
        ...
        <ElFormItem label="所属站点名称">
          <ElInput v-model="memberForm.stopName" placeholder="请输入" />
        </ElFormItem>
        <ElFormItem label="骑手编号">
          <ElInput v-model="memberForm.idNum" placeholder="请输入" />
        </ElFormItem>
        <ElFormItem label="备注">
